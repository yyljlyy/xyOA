	...
	<center>
		<div class="ItemBlock_Title1" style="width: 98%;">
			<font class="MenuPoint"> &gt; </font>
				<s:a action="forumAction_list" namespace="/">论坛</s:a>
			<font class="MenuPoint"> &gt; </font>
			${name }
			<span style="margin-left:30px;">
				<a href="${pageContext.request.contextPath}/BBS_Topic/saveUI.html">
				...
				<tbody class="dataContainer" datakey="topicList">
					<s:iterator value="topicList">
						<tr height="35" id="d0" class="template">
							...
							<td class="Topic"><a class="Default" href="${pageContext.request.contextPath}/BBS_Topic/topicShow.html">
								${title}
							</a></td>
							...
							<td class="ForumTopicPageDataLine Reply" align="center"><b>
								${replyCount}
							</b></td>
							<td class="ForumTopicPageDataLine">
								<ul class="ForumPageTopicUl">
